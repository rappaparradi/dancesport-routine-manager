...
package com.rappasocial.routinemanager.authenticator;
...
import com.rappasocial.routinemanager.Constants;
import com.rappasocial.routinemanager.R;
import com.rappasocial.routinemanager.client.NetworkUtilities;
...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        dialog.setMessage(getText(R.string.login_activity_label));
    ...
    protected void finishLogin() {
        ...
        if (mRequestNewAccount) {
            ...
            ContentResolver.setSyncAutomatically(account,
                "com.rappasocial.routinemanager.DummyProvider", true);
            ContentResolver.setIsSyncable(account, "com.rappasocial.routinemanager.DummyProvider", 1);
